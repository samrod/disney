(() => {
  ...
  // src/lib/api.ts
  var fetchData = async (uri) => {
    try {
      const response = await axios_default.get(uri);
  ...
  var fetchList = async () => {
    ...
    return (data == null ? void 0 : data.StandardCollection) || {};
  };

  // src/lib/store.ts
  var useStore = (0, import_vanilla.createStore)((set, get) => ({
    containers: [],
    sets: [],
    items: [],
    loading: false,
  ...
  var compileTemplate = (templateId, data) => {
    const templateSource = $(templateId).innerHTML;
    const template = import_handlebars.default.compile(templateSource);
    return template(data);
  };
  var getItemTitle = ({ title }) => {
    var _a, _b, _c;
    const { full } = title;
    return ((_a = full.series) == null ? void 0 : _a.default.content) || ((_b = full.program) == null ? void 0 : _b.default.content) || ((_c = full.collection) == null ? void 0 : _c.default.content) || full.set.default.content;
  };
  var getItemImage = (image, type, aspect) => {
    var _a, _b, _c, _d;
    ...
    return ((_a = imageType == null ? void 0 : imageType.series) == null ? void 0 : _a.default.url) || ((_b = imageType == null ? void 0 : imageType.program) == null ? void 0 : _b.default.url) || ((_c = imageType == null ? void 0 : imageType.default) == null ? void 0 : _c.default.url) || ((_d = imageType == null ? void 0 : imageType.collection) == null ? void 0 : _d.default.url);
  };

  // src/lib/render.ts
  var renderContainers = (containers) => {
    const containerElement = $("#containers");
    if (!containerElement)
      return;
    $("#root").innerHTML += compileTemplate("#containers", containers);
  };
  var registerHelpersAndPartials = () => {
    import_handlebars2.default.registerPartial("tile", $("#tile").innerHTML);
    import_handlebars2.default.registerPartial("container", $("#container").innerHTML);
    import_handlebars2.default.registerHelper("getItemTitle", getItemTitle);
    import_handlebars2.default.registerHelper("getItemImage", getItemImage);
  };

  // src/app.ts
  var init = async () => {
    registerHelpersAndPartials();
    await store_default.getState().fetchContainers();
