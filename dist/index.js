(() => {
  ...
  // src/components.ts
  var renderItem = (itemDiv, item) => {
    const itemsDiv = document.createElement("div");
    itemDiv.className = "item-tile";
    itemDiv.innerText = item.title;
    itemsDiv.appendChild(itemDiv);
  };
  var renderContainer = (containerElement, container) => {
    const containerDiv = document.createElement("div");
    containerDiv.className = `container ${container.style}`;
    if (container.set.items) {
      container.set.items.forEach(renderItem.bind(null, containerDiv));
    }
  ...
  var renderContainers = (containers) => {
    ...
    containers.forEach(renderContainer.bind(null, containerElement));
  };
